import _srcUtilsInit from "./src/utils/init";
import { loadPlugins, loadYML, processed } from "./src/utils/load";
import { createClient } from "oicq";
var module = {
  exports: {}
};
var exports = module.exports;
const botEnvironment = _srcUtilsInit;
const Setting = loadYML("setting");
const Greeting = loadYML("greeting"); // 1:安卓手机 2:aPad 3:安卓手表 4:MacOS 5:iPad
...
global.bot = BOT;
global.master = MASTER; // 未配置则不复读群消息

global.repeatProb = REPEATPROB ? REPEATPROB : 0; // 未配置则不发送群通知

global.groupHello = GROUPHELLO ? GROUPHELLO : 0; // 未配置则向新群员问好

global.groupGreetingNew = GROUPGREETINGNEW ? GROUPGREETINGNEW : 1; // 未配置则向新好友问好
