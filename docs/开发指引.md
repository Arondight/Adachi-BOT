...
```patch
From 612bf46be9d35d641b9fcd9e341036a6afb6eb56 Mon Sep 17 00:00:00 2001
From: Qin Fandong <shell_way@foxmail.com>
Date: Sat, 6 Nov 2021 18:26:53 +0800
...
index 11f6749..34dae80 100644
--- a/src/plugins/master/index.js
+++ b/src/plugins/master/index.js
@@ -49,6 +49,7 @@ async function Plugin(msg) {
...
+      await setAuth(msg, "hello_world", ...parse(msg.text, "fun_auth"));
       break;
...
| 属性 | 内容 |
| --- | --- |
| `msg.bot` | QQ 客户端， [createClient](https://github.com/takayama-lily/oicq/blob/dc4c63f9774fe806a3d0c48c17a017fd62373aea/lib/client.ts#L641-L646) 返回的 new [Client](https://github.com/takayama-lily/oicq/blob/dc4c63f9774fe806a3d0c48c17a017fd62373aea/lib/client.ts#L29-L584) |
| `msg.atMe` | 有人 `@` 机器人为 `true` ，否则为 `false` |
| `msg.uid` | 消息发送者的 QQ 号 |
| `msg.gid` | 群消息为群号，否则为 `undefined` |
