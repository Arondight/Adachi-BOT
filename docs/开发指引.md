...
| 变量                    | 数据                                                                   | 引入阶段     |
| ----------------------- | ---------------------------------------------------------------------- | ------------ |
| `global.rootdir`        | 项目所在的目录                                                         | `readConfig` |
| `global.package`        | `../package.json`                                                      | `readConfig` |
| `global.all`            | `../config*/command.yml` 和 `../config*/command_master.yml` 的部分内容 | `readConfig` |
| `global.command`        | `../config*/command.yml`                                               | `readConfig` |
| `global.master`         | `../config*/command_master.yml`                                        | `readConfig` |
| `global.artifacts`      | `../config*/artifacts.yml`                                             | `readConfig` |
| `global.config`         | `../config*/setting.yml`                                               | `readConfig` |
| `global.cookies`        | `../config*/cookies.yml`                                               | `readConfig` |
| `global.greeting`       | `../config*/greeting.yml`                                              | `readConfig` |
| `global.menu`           | `../config*/menu.yml`                                                  | `readConfig` |
| `global.prophecy`       | `../config*/prophecy.yml`                                              | `readConfig` |
| `global.names`          | `../config*/names.yml`                                                 | `readConfig` |
| `global.eggs`           | `../config*/pool_eggs.yml`                                             | `readConfig` |
| `global.info.character` | `../resources/Version2/info/docs/<角色名>.json`                        | `readConfig` |
