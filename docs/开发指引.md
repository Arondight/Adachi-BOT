...
你可以通过以下版本的 Vue 中导出的变量 `window.Vue` 来使用 [Vue.js](https://github.com/vuejs/vue.git) 。
...
你可以通过 `../data/js/lodash.min.js` 中导出的变量 `window._` 来使用 [lodash](https://github.com/lodash/lodash.git) 。
