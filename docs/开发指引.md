...
你可以通过下列恰当的 Vue 版本中导出的变量 `Vue` 来使用 [Vue.js](https://github.com/vuejs/vue.git) 。
...
你可以通过 `../data/js/lodash.min.js` 中导出的变量 `_` 来使用 [lodash](https://github.com/lodash/lodash.git) 。
