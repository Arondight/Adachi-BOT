...
4. `../resources_custom/Version2/thumb/character/<中文角色名>.png`，这里是`【今日素材】`、`【米游社】`和`【UID】`中的角色图标。
5. `../resources_custom/Version2/costumes/splashes/<中文时装名>.png`，可能的时装图，会在`【我的】`、`【米游社】`中使用。
6. `../resources_custom/Version2/costumes/avatars/<中文时装名>.png`，这里是`【米游社】`和`【UID】`中可能的时装图标。
