...
CHARIDS=(
  ...
  # 达达利亚 莫娜       行秋       芭芭拉     神里绫人   夜兰       珊瑚宫心海
  '10000033' '10000041' '10000025' '10000014' '10000066' '10000060' '10000054'
  # 妮露      坎蒂丝
  '10000070' '10000072'
  # 迪卢克   可莉       胡桃       班尼特     香菱       安柏       辛焱
  ...
  # 八重神子  久岐忍     多莉       赛诺
  '10000058' '10000065' '10000068' '10000071'
  # 钟离     阿贝多     凝光       诺艾尔     五郎       荒泷一斗   云堇
...
WEAPONS=(
  ...
  '钟剑'         '千岩古剑'     '衔珠海皇'     '恶王丸'       '森林王器'
  '玛海菈的水色'
  '无工之剑'     '狼的末路'     '天空之傲'     '松籁响起之时' '赤角石溃杵'
  # 弓
  '猎弓'         '历练的猎弓'
  '鸦羽弓'       '信使'         '弹弓'         '反曲弓'       '神射手之誓'
  '绝弦'         '风花之颂'     '幽夜华尔兹'   '钢轮弓'       '西风猎弓'
  '弓藏'         '黑岩战弓'     '试作澹月'     '宗室长弓'     '破魔之弓'
  '暗巷猎手'     '祭礼弓'       '苍翠猎弓'     '曚云之月'     '掠食者'
  '落霞'         '贯月矢'       '竭泽'
...
MATERIALS=(
  ...
  '「诤言」的教导' '「诤言」的指引' '「诤言」的哲学'
  '「巧思」的教导' '「巧思」的指引' '「巧思」的哲学'
  ...
  '鸣神御灵的欢喜' '鸣神御灵的明惠' '鸣神御灵的亲爱' '鸣神御灵的勇武'
  '谧林涓露的铜符' '谧林涓露的铁符' '谧林涓露的银符' '谧林涓露的金符'
  '绿洲花园的追忆' '绿洲花园的恩惠' '绿洲花园的哀思' '绿洲花园的真谛'
  '烈日威权的残响' '烈日威权的余光' '烈日威权的梦想' '烈日威权的旧日'
  # 角色升级材料
  '嘟嘟莲'       '绯樱绣球'     '风车菊'       '钩钩果'       '海灵芝'
  '绝云椒椒'     '琉璃百合'     '琉璃袋'       '落落莓'       '慕风蘑菇'
  '霓裳花'       '蒲公英籽'     '清心'         '塞西莉亚花'   '石珀'
  '小灯草'       '星螺'         '夜泊石'       '鸣草'         '晶化骨髓'
  '珊瑚真珠'     '天云草实'     '血斛'         '幽灯蕈'       '劫波莲'
  '月莲'         '树王圣体菇'   '圣金虫'        '枣椰'        '赤念果'
)
