...
MATERIALS=(
  ...
  '须弥角色天赋周一绿' '须弥角色天赋周一蓝' '须弥角色天赋周一紫'
  '须弥角色天赋周二绿' '须弥角色天赋周二蓝' '须弥角色天赋周二紫'
  '须弥角色天赋周三绿' '须弥角色天赋周三蓝' '须弥角色天赋周三紫'
  # 武器本
  ...
  '须弥武器突破周一绿' '须弥武器突破周一蓝' '须弥武器突破周一紫' '须弥武器突破周一金'
  '须弥武器突破周二绿' '须弥武器突破周二蓝' '须弥武器突破周二紫' '须弥武器突破周二金'
  '须弥武器突破周三绿' '须弥武器突破周三蓝' '须弥武器突破周三紫' '须弥武器突破周三金'
  # 角色升级材料
