...
async function Plugin(msg) {
  switch (true) {
    ...
    case hasEntrance(msg.text, "gacha", "select-what"):
      if (checkAuth(msg, "select-what")) {
        doSelectWhat(msg);
      }
      break;
    case hasEntrance(msg.text, "gacha", "select-nothing"):
      if (checkAuth(msg, "select-nothing")) {
        doSelectNothing(msg);
      }
      break;
    case hasEntrance(msg.text, "gacha", "select"): {
      ...
      if (guess.length > 0 && checkAuth(msg, "select")) {
