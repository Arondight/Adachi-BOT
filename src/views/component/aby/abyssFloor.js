  ...
  <div class="container-vertical container-chamber-info">
    ...
    <div v-if="isValidChamberData" class="chamber-details valid">
      <div class="first-half">
        <characterShowbox v-for="character in chamberDetails[0]['avatars']" :htmlClass="'chamber-character'" :prefix="'Lv.'" :suffix="''" :data="character" />
      </div>
      <div class="second-half">
        <characterShowbox v-for="character in chamberDetails[1]['avatars']" :htmlClass="'chamber-character'" :prefix="'Lv.'" :suffix="''" :data="character" />
      </div>
    </div>
